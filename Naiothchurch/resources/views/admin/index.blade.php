...
@section('admin')
    ...
    use App\Models\Category; // Replace YourModel with the actual model class you're using
    $Categories = Category::count();
    $Members=\App\Models\Member::count();
    $Events=\App\Models\Events::count();
    $Articles=\App\Models\Articles::count();
    @endphp
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-truncate font-size-14 mb-2">Members</p>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-truncate font-size-14 mb-2"> Articles</p>
