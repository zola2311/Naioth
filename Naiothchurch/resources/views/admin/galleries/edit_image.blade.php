                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Gallery Image</h4> <br><br>
                            ...
                            <form method="post" action="{{ route('update.image') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="images" class="form-control" type="file" id="images" >
                                    </div>
                                    @error('images')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ asset( $editableImage->images)  }}" alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->
